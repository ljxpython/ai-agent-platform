# platform-web 知识工作台实施方案

## 1. 文档目的

本文说明 `apps/platform-web` 在新默认口径下如何承接知识工作台。
...
- 知识页面由 `platform-api` 提供控制面 facade
...
这轮讨论里，`platform-web` 的 file-level 主锚点明确为：

- `apps/platform-web/src/services/knowledge/knowledge.service.ts`

配套页面/组件落点为：

- `apps/platform-web/src/modules/knowledge/pages/KnowledgeRetrievalPage.vue`
- `apps/platform-web/src/modules/knowledge/components/KnowledgeQuerySettingsPanel.vue`
- `apps/platform-web/src/modules/knowledge/pages/KnowledgeDocumentsPage.vue`
- `apps/platform-web/src/modules/knowledge/pages/KnowledgeSettingsPage.vue`

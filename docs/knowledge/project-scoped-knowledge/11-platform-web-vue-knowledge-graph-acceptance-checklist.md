# platform-web-vue 知识图谱验收清单

## 1. 环境

- [ ] `./scripts/platform-web-vue-demo-down.sh` 正常
- [ ] `./scripts/platform-web-vue-demo-up.sh` 正常
- [ ] LightRAG 参考服务可运行
- [ ] 登录后能进入本地图谱页
...
- [ ] `pnpm typecheck` 通过
- [ ] `pnpm build` 通过
- [ ] `pytest -q apps/platform-api-v2/tests/test_project_knowledge_contract.py` 通过

...
class Settings(BaseSettings):
    ...
    OPENAI_API_KEY: str = os.getenv(
        "OPENAI_API_KEY", "sk-04d0650a86124b31be03bb6c7bbaa036"
    )
    ...
    HYBRID_RETRIEVAL_ENABLED: bool = (
        os.getenv("HYBRID_RETRIEVAL_ENABLED", "true").lower() == "true"
    )
    ...
    AUTO_LEARNING_ENABLED: bool = (
        os.getenv("AUTO_LEARNING_ENABLED", "true").lower() == "true"
    )
    FEEDBACK_LEARNING_ENABLED: bool = (
        os.getenv("FEEDBACK_LEARNING_ENABLED", "true").lower() == "true"
    )

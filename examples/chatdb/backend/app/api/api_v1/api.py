...
api_router.include_router(
    text2sql_sse.router, prefix="/text2sql-sse", tags=["text2sql-sse"]
)
api_router.include_router(
    value_mappings.router, prefix="/value-mappings", tags=["value-mappings"]
)
api_router.include_router(
...
api_router.include_router(
    relationship_tips.router, prefix="/relationship-tips", tags=["relationship-tips"]
)

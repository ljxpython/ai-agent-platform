              ...
              <>
                {documentOverview && (
                  <div className="grid grid-cols-1 gap-2 mb-4">
                    <InfoRow label="摘要" value={documentOverview.summary} />
                    <InfoRow label="文档ID" value={documentOverview.id} />
                    <InfoRow label="标题" value={documentOverview.title} />
                    <InfoRow
                      label="类型"
    ...
    <div className="border border-gray-700 rounded-lg mb-4 bg-zinc-800/50 transition-colors">
      ...
      >
        <span className="font-medium text-lg">
          片段 {chunk.metadata?.chunk_order ?? index + 1}
        </span>
      ...
      {localExpanded && (
        <div className="px-6 pb-4 text-gray-300 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <InfoRow label="提取ID" value={chunk.id} />
            <InfoRow label="文档ID" value={chunk.documentId} />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <InfoRow label="用户ID" value={chunk.userId} />
            <ExpandableInfoRow label="集合ID" values={chunk.collectionIds} />
          </div>

          <div className="space-y-2 bg-zinc-800 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="font-medium text-white">内容:</span>
              {isEditing && (
  ...
  return (
    <div className="border border-gray-700 rounded-lg mb-4 bg-zinc-800/50 transition-colors">
      ...
      {localExpanded && (
        <div className="px-6 pb-4 text-gray-300 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <InfoRow label="实体ID" value={entity.id} />
            <InfoRow label="类别" value={entity.category} />
          </div>
          <ExpandableInfoRow label="片段ID" values={entity.chunkIds} />

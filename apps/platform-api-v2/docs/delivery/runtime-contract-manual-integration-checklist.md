...
- [ ] 已启动 `apps/platform-api-v2`
- [ ] 已启动 `apps/platform-web-vue`
- [ ] 浏览器能正常登录 `platform-web-vue`
- [ ] 当前账号至少有一个可访问项目
- [ ] 当前项目下至少存在一个可用 graph
...
- `apps/platform-web-vue/src/services/runtime/runtime-contract.ts`
- `apps/platform-web-vue/src/services/assistants/assistants.service.ts`
- `apps/platform-web-vue/src/modules/chat/composables/platform-chat-stream/actions.ts`
...
- `apps/platform-api-v2/app/core/runtime_contract.py`
- `apps/platform-api-v2/app/modules/assistants/application/service.py`
- `apps/platform-api-v2/app/modules/runtime_gateway/application/service.py`
- `apps/platform-api-v2/app/adapters/langgraph/parameter_schema.py`

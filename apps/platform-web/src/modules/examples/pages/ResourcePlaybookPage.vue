...
const stats = [
  {
    label: '核心原则',
    value: 3,
    hint: '功能与风格都看当前 platform-web，参考看 sub2api-base。',
    icon: 'check',
    tone: 'primary'
  },
  {
...
const principles = [
  {
    title: '功能真相源固定',
    description: '页面和功能是否完整，一律以当前 apps/platform-web 为准。后续增强直接在这一套正式宿主里延续，不再并行维护第二套真相源。',
    icon: 'project'
  },
  {
    title: '风格和交互以当前 VUE 版为基线',
    description: '后续新增页面必须像当前 platform-web，而不是每次重新试风格。sub2api-base 只作为参考源，不作为开发宿主。',
    icon: 'sparkle'
  },
  {
    title: '先选母版再写页面',
...
const workflow = [
  '先确认当前 apps/platform-web 里是否已经有对应功能、页面或可复用母版。',
...
<template>
  <section class="pw-page-shell">
    <PageHeader
      eyebrow="Resources"
      title="前端开发范式"
      description="这页不展示模板源码，而是把 platform-web 的正式开发规则、页面母版和组件复用方式固定下来。后续开发者默认先看这里，再去挑模板。"
    />

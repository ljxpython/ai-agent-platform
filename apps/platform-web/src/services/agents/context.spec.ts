...
it('uses only context schema fields and validates numbers', () => {
  ...
  expect(parseAgentContext({ temperature: '0', tools: ['execute'], execution_mode: 'pro', principal: 'forged' }, fields)).toEqual({ temperature: 0, execution_mode: 'pro' })

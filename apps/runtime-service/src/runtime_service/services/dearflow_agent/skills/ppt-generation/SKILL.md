...
Create a JSON file in `/workspace/work/` with the presentation structure. **Important**: Include the `style` field to define the overall visual consistency.
...
python /skills/image-generation/scripts/generate.py \
  --prompt-file /workspace/work/slide-03-prompt.json \
  --reference-images /workspace/work/slide-02.jpg \
  --output-file /workspace/work/slide-03.jpg \
  --aspect-ratio 16:9

# Slide 4 references slide 3
python /skills/image-generation/scripts/generate.py \
  --prompt-file /workspace/work/slide-04-prompt.json \
  --reference-images /workspace/work/slide-03.jpg \
  --output-file /workspace/work/slide-04.jpg \
  --aspect-ratio 16:9
```
...
python /skills/ppt-generation/scripts/generate.py \
  --plan-file /workspace/work/presentation-plan.json \
  --slide-images /workspace/work/slide-01.jpg /workspace/work/slide-02.jpg /workspace/work/slide-03.jpg \
  --output-file /workspace/work/presentation.pptx
```
...
Create `/workspace/work/ai-product-plan.json`:
```json
{
...
Create `/workspace/work/nova-slide-01.json`:
```json
{
...
Create `/workspace/work/nova-slide-02.json`:
```json
{
...
```bash
python /skills/ppt-generation/scripts/generate.py \
  --plan-file /workspace/work/nova-plan.json \
  --slide-images /workspace/work/nova-slide-01.jpg /workspace/work/nova-slide-02.jpg /workspace/work/nova-slide-03.jpg /workspace/work/nova-slide-04.jpg /workspace/work/nova-slide-05.jpg \
  --output-file /workspace/work/nova-presentation.pptx
```
...
- The PPTX file is saved in `/workspace/work/`

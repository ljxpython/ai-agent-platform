...
async def deny_image_scope_on_server_resources(ctx: Auth.types.AuthContext, value: dict) -> None:
    ...
    if scope.get("operation") in {"image-upload", "image-read", "workspace-file-upload", "workspace-file-read", "workspace-fork", "dear-skills-read", "dear-skills-write", "dear-governance-read", "dear-governance-write", "terminal-read", "terminal-write"}:

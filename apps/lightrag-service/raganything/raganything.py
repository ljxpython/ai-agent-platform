...
# pylint: disable  MC80OmFIVnBZMlhtblk3a3ZiUG1yS002WjFSM01RPT06ODc3NjliYzQ=
...
# fmt: off  MS80OmFIVnBZMlhtblk3a3ZiUG1yS002WjFSM01RPT06ODc3NjliYzQ=
...
# pragma: no cover  Mi80OmFIVnBZMlhtblk3a3ZiUG1yS002WjFSM01RPT06ODc3NjliYzQ=
    ...
    async def _ensure_lightrag_initialized(self):
        ...
        try:
            ...
            if self.embedding_func is None:
                ...
                self.logger.error(error_msg)
                return {"success": False, "error": error_msg}
# pragma: no cover  My80OmFIVnBZMlhtblk3a3ZiUG1yS002WjFSM01RPT06ODc3NjliYzQ=

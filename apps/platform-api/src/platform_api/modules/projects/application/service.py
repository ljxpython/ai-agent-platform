...
from platform_api.modules.projects.application.contracts import (
...
from platform_api.modules.projects.application.ports import StoredProject, StoredProjectMemberView
from platform_api.modules.projects.domain import (
    ProjectMemberPage,
    ...
    async def get_access(self, *, actor: ActorContext, project_id: str) -> ProjectAccess:
        ...
        async with SqlAlchemyUnitOfWork(session_factory) as uow:
            ...
            if actor.principal_type == "user":
                ...
                from platform_api.modules.service_accounts.infra.sqlalchemy.repository import SqlAlchemyServiceAccountsRepository

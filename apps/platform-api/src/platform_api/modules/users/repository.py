...
from platform_api.modules.projects.models import ProjectMemberRecord, ProjectRecord
from platform_api.modules.users.records import (
    StoredPlatformUser,
...
class SqlAlchemyUsersRepository:
    ...
    def list_users(
        ...
        *,
        ...
        stmt = (
            base_stmt.order_by(desc(UserRecord.created_at)).offset(offset).limit(limit)
        )

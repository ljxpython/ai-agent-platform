...
from platform_api.core.db.session import session_scope
...
from platform_api.modules.operations.application.execution import OperationExecutorRegistry, actor_from_operation
